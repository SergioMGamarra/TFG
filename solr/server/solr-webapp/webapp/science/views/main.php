...
<head>
    ...
    if ($_POST) {
        if ($_POST['busca']) {
            $result = buscador($connection, $_POST['busca']);
            /*
            $request = "http://192.168.1.102:8983/solr/Recommender/select?indent=on&q=".$_POST['busca']."&wt=json";
            echo $request;
            //  Initiate curl
            $ch = curl_init();
            ...
            */
            //  Initiate curl
            $url = "http://localhost:8983/solr/Recommender/select?indent=on&q=".$_POST['busca']."";
            ...
            <ul class="nav navbar-nav navbar-right" style="color: white!important;">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-toggle" href="recommender.php"><i class="icon-pencil fa-fw"></i>Mis recomendaciones</a>
                        </li>
                        <li>
...
<div class="container margin-top-large" style="background-color: white">
    <div class="container">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            ...
            <input name="busca" value="<?php if($_POST) echo $_POST['busca']; else if ($_GET) echo $autor; ?>" class="main-buscador"><div onclick = "document.getElementById('form-buscador').submit();" class="btn-buscador"><span class="search-icon glyphicon glyphicon-search"></span></div>
            </div>
            </form>
