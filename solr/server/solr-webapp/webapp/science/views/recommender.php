    ...
    <div class="container">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="full-width resultados">
                ...
                <p style="color: grey">* Recuerda que estás son tus 10 recomendaciones para hoy, es posible que si no las puntuas podrás cambiar mañana, en caso de que las puntúes ya no volverán a aparecer en esta lista pero podrás consultarlos en tu lista de artículos votados.</p>
                <?php
                $i = 0;
