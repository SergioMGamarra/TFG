...
<div class="container margin-top-large" style="background-color: white">
    <div class="container">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            ...
            <a target="_blank" href="localhost:8888/science/solr/<?php echo $art['enlace']?>"><button class="btn btn-art full-width tam-input-big-art">Leer el artículo completo <span class="glyphicon glyphicon-arrow-right"></span></button> </a>
